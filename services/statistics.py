...
class StatisticsService:
    ...
    @staticmethod
    async def get_timedelta_menu(callback_data: StatisticsCallback) -> tuple[str, InlineKeyboardBuilder]:
        kb_builder = InlineKeyboardBuilder()
    ...
    @staticmethod
    async def get_statistics(callback_data: StatisticsCallback, session: AsyncSession):
        kb_builder = InlineKeyboardBuilder()
        match callback_data.statistics_entity:
            case StatisticsEntity.USERS:
                ...
                kb_builder = await add_pagination_buttons(
                    ...
                    None)
                kb_builder.row(AdminConstants.back_to_main_button, callback_data.get_back_button())
