...
* [5.0 Multibot (Experimental functionality)](#50-multibot-experimental-functionality)
    + [5.1 Starting the multibot](#51-starting-the-multibot)
* [📋 Todo List](#-todo-list)
* [MIT License](LICENSE)
...
![img](https://i.imgur.com/dhk9600.gif)
...
## 5.0 Multibot (Experimental functionality)

### 5.1 Starting the multibot
