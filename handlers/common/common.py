...
async def add_pagination_buttons(keyboard_builder: InlineKeyboardBuilder, callback_str: str, max_page_function,
    ...
    if unpacked_callback.page > 0:
        ...
        buttons.append(types.InlineKeyboardButton(text=Localizator.get_text_from_key("pagination_first"), callback_data=first_page_callback.pack()))
        buttons.append(types.InlineKeyboardButton(text=Localizator.get_text_from_key("pagination_previous"), callback_data=back_page_callback.pack()))
    if unpacked_callback.page < maximum_page:
        ...
        buttons.append(types.InlineKeyboardButton(text=Localizator.get_text_from_key("pagination_next"),
                                                  callback_data=unpacked_callback.pack()))
        buttons.append(types.InlineKeyboardButton(text=Localizator.get_text_from_key("pagination_last"), callback_data=last_page_callback.pack()))
